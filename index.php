...
require_once __DIR__ . '/controllers/reader_controller.php';
require_once __DIR__ . '/controllers/author_controller.php';
...
switch ($page) {
    ...
    case 'reader':
        require_role('reader');
        reader_controller($conn);
        break;

    case 'author':
        require_role('author');
        author_controller($conn);
        break;
